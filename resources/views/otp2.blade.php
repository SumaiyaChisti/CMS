        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/confirm"  method="POST">
                @csrf
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" value="{{session('email2')}}" readonly name="email" placeholder="Enter your email" />
