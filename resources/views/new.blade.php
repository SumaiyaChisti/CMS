        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/setpass"  method="POST">
                @csrf
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" value="{{session('email2')}}" readonly name="email3" placeholder="Enter your email" />
                 
                </div>
                <div class="mb-3 form-password-toggle">
                  <label class="form-label" for="otp">New Password</label>
